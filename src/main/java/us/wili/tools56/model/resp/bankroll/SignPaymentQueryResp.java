 ...
 */
public class SignPaymentQueryResp extends BaseResp {
    ...
    public static SignPaymentQueryResp fromJson(String content) {
        return JSONObject.parseObject(content, SignPaymentQueryResp.class);
    }
