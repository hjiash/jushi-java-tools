 ...
 */
public class RevokeAutoBidResp extends BaseResp {
    ...
    public static RevokeAutoBidResp fromJson(String content) {
        return JSONObject.parseObject(content, RevokeAutoBidResp.class);
    }
