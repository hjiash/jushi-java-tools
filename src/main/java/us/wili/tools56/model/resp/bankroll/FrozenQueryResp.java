 ...
 */
public class FrozenQueryResp extends BaseResp {
    ...
    public static FrozenQueryResp fromJson(String content) {
        return JSONObject.parseObject(content, FrozenQueryResp.class);
    }
