 ...
 */
public class SignTransferQueryResp extends BaseResp {
    ...
    public static SignTransferQueryResp fromJson(String content) {
        return JSONObject.parseObject(content, SignTransferQueryResp.class);
    }
