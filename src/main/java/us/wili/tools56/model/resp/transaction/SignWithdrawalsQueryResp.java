 ...
 */
public class SignWithdrawalsQueryResp extends BaseResp {
    ...
    public static SignWithdrawalsQueryResp fromJson(String content) {
        return JSONObject.parseObject(content, SignWithdrawalsQueryResp.class);
    }
