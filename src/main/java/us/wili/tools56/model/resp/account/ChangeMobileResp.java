 ...
 */
public class ChangeMobileResp extends BaseResp {
    ...
    public static ChangeMobileResp fromJson(String content) {
        return JSONObject.parseObject(content, ChangeMobileResp.class);
    }
