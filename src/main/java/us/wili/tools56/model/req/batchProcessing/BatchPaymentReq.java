 ...
 */
public class BatchPaymentReq extends BaseReqDto {
    ...
    public class ItemsBean {
        ...
        @ApiModelProperty(value = "结束标识位，1：结束；0：未结束, 1个字符", required = true)
        ...
        @Pattern(regexp = "^[0|1]{1}$",message = "错误的结束标志位代码")
        @NotBlank(message = "\t结束标识位不能为空")
